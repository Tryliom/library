...
<tr>
	<td><input id='bookmanager".($choice=='take_book' ? '_selected' : '')."' type='submit' name='take_book' value='Emprunter un livre' /></td>
	<td><input id='bookmanager".($choice=='return_book' ? '_selected' : '')."' type='submit' name='return_book' value='Rendre un livre' /></td>
</tr>
